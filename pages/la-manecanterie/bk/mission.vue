...
const page = {
    ...
    title: "Mission",
    breadcrumb: [
        { title: "Formation artistique", href: "/la-manecanterie/formation-artistique" },
        { title: "Formation spirituelle", href: "/la-manecanterie/formation-spirituelle" }
    ]
};
const { data: content } = await useAsyncData(() => queryCollection('manecanterie').where('title', "=", "Mission").first());
</script>
